...
import com.javierreansyah.pinecone.ui.features.reader.components.overlay.ReaderOverlay
import com.javierreansyah.pinecone.ui.theme.PineconeTheme
...
class ReaderActivity : AppCompatActivity(), ReaderNavigationRouter {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        composeView.setContent {
            ...
            PineconeTheme(readerBackgroundColor = readerBgColor) {
                ReaderOverlay(
                    viewModel = viewModel,
    ...
    override fun navigateToBookInfo(bookId: String) {
        val infoIntent = Intent(this, com.javierreansyah.pinecone.MainActivity::class.java).apply {
